...
//@formatter:off
     ...
     */
    @NonNull
    private static final String EXTRA_BOOLEAN_WAS_SCREEN_ON = TaskerPluginService.class.getName()
    ...
    private static final PartialWakeLockForService PARTIAL_WAKE_LOCK
            ...
            TaskerPluginService.class.getName());
    ...
    public static void startService(@NonNull final Context context, final boolean isScreenOn) {
        ...
        final Intent intent = new Intent(context, TaskerPluginService.class);
